...
public class InMemoryProductRepository implements ProductRepository{
	...
	Product iphone = new Product("P1234","iPhone 5s", new BigDecimal(499));
	...
	public List <Product> getProductsByPriceFilter(Map<String,List<String>> filterParams) {
        ...
        if(criterias.contains("low")) {
        	min=new BigDecimal (filterParams.get("low").get(0));
        }
        if(criterias.contains("high")) {
        	max=new BigDecimal (filterParams.get("high").get(0));
        }
