...
<div class="super_container">
	...
	<div class="super_container_inner">
		...
		<div class="cart_section" ng-app="cartApp">
			<div class="container" ng-controller="cartCtrl" ng-init="initCartId('${cartId}')">
				<div class="row">
					<div class="col">
						<div class="cart_container">
							...
							<!-- Cart Items -->
							<div class="cart_items" ng-repeat="item in cart.cartItems">
								<ul class="cart_items_list" >
									...
									<li class="cart_item item_list d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-end justify-content-start">
										<div class="product d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-start mr-auto">
											...
											<div><div class="product_image"><img src="<c:url value="/resource/images/images/cart_item_1.jpg"></c:url>" alt=""></div></div>
										...
										<div class="product_color product_text"><span>Color: </span>Black</div>
										<div class="product_price product_text"><span>Price: </span>{{item.product.unitPrice}}</div>
										...
										<div class="product_total product_text"><span>Total: </span>{{item.totalPrice}}</div>
									</li>
								</ul>
							</div>
							...
							<div class="cart_buttons d-flex flex-row align-items-start justify-content-start">
								<div class="cart_buttons_inner ml-sm-auto d-flex flex-row align-items-start justify-content-start flex-wrap">
									<div class="button button_clear trans_200"><a href="#" ng-click="clearCart()">clear cart</a></div>
									<div class="button button_continue trans_200"><a href="<spring:url value="/products" />">continue shopping</a></div>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="cart_extra_content cart_extra_total">
								...
								<ul class="cart_extra_total_list">
									<li class="d-flex flex-row align-items-center justify-content-start">
										...
										<div class="cart_extra_total_value ml-auto">Price</div>
									</li>
									<li class="d-flex flex-row align-items-center justify-content-start">
								...
								<div class="checkout_button trans_200"><a href="<spring:url value="/checkout?cartId=${cartId}"/>">proceed to checkout</a></div>
							</div>
						</div>
					</div>
				</div>
